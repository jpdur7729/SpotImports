# ------------------------------------------------------------------------------
#                     Author    : FIS - JPD
#                     Time-stamp: "2021-03-30 11:41:32 jpdur"
# ------------------------------------------------------------------------------
...
# -------------------------------------------------------------- 
# import-module -Force -Name ./MAS/MASLib

# Create the object that will be returned afterwards
$SourceDef = SourceDef -Name "MAS" -BaseCurrency "SGD"
...
$ExtractDataFct = {
    ...
    $request = createRequest -StartDate ($StartDateasDate.ToString("yyyy-MM-dd")) -EndDate ($EndDateasDate.ToString("yyyy-MM-dd"))

    # Debug 
    # Write-Host $request

    # return the result of the request
    return extractRawData -request $request
